<?php
    $id_anggota = $_GET['id'];
    $q_tampil_anggota = mysqli_query($db, "SELECT * FROM anggota WHERE idanggota='$id_anggota'"); 
...
<div id="content">
    ...
    <table id="tabel-input">
        ...
        <tr>
            ...
            {
                echo "<td class='isian-formulir'><input type='radio' name='jenis_kelamin' value='Pria' checked>Pria</label></td></tr>"; 
                echo "<tr><td class='label-formulir'></td><td class='isian-formulir'><input type='radio' name='jenis_kelamin' value='Wanita'>Wanita</td>"; 
            }
            elseif($r_tampil_anggota['jeniskelamin']=="Wanita") 
            {
                echo "<td class='isian-formulir'><input type='radio' name='jenis_kelamin' value='Pria'>Pria</label></td></tr>"; 
                echo "<tr><td class='label-formulir'></td><td class='isian-formulir'><input type='radio' name='jenis_kelamin' value='Wanita' checked>Wanita</td>"; 
            }
            ?>
        </tr>
        <tr>
